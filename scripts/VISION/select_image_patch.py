...
#
# Instructions:
# Run with: python3 select_image_patch.py -i input_image.jpg -f output_filename
...
ap.add_argument("-f", "--filename", required=True, help="filename for the json containing the cropping points")
...
if len(refPt) == 2:
	...
	roi_points = {
	"Corner1": [refPt[0][0],refPt[0][1]],
	"Corner2": [refPt[1][0],refPt[1][1]]
	}
	...
	generateFile(roi_json,(args["filename"]+".json"))
